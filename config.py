...
# SIGN_ROUTE_FIXED_FIRST_CHOICE = "RIGHT"
...
FORK_BOUNDARY_WIDTH_RATIO = 0.80
...
# # # 3. 绕完两辆车并完成回正后高速巡线60
# POST_CAR_TARGET_SPEED = 60
# POST_CAR_STANLEY_LATERAL_GAIN = 0.36
# POST_CAR_STANLEY_LATERAL_D_GAIN = 0.026
# POST_CAR_STANLEY_HEADING_GAIN = 0.12
# POST_CAR_STANLEY_SPEED_ESTIMATE = POST_CAR_TARGET_SPEED
# ---------------------------------------------------------------------------
